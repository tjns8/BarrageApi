						...
						action="toregister.php"
							...
							<div class="reg-inner login">
								...
								<ol class="clearfix">
									...
									<li><label for="password">重复密码</label> <input
										type="password" class="input" placeholder="请重复输入密码"
										target="password" id="password" name="password" /> <span
										class="icon i-pwd" style="top: 14px;"></span> <span
										class="errorinfo" target="password" style="display: none;">请输入您的密码</span>
									</li>
									<li
										...
										<input type="submit" value="注册" class="refer" id="devLoginBtn">
									</li>
								</ol>
							</div>
						</form>
